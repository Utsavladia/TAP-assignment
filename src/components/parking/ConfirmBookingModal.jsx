...
const ConfirmBookingModal = ({ parking, onConfirm, onCancel, userLocation }) => {
    ...
    return (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-40 backdrop-blur-sm">
            ...
            ></div>
            {/* Modal */}
            <div className="relative bg-black rounded-2xl p-8 max-w-md w-full mx-4 shadow-2xl ">
                <h2 className="text-2xl font-bold text-white mb-2 text-center">Confirm Booking</h2>
                <div className="flex flex-col items-center mb-4">
                    ...
                    <div className="flex gap-4 text-gray-300 text-sm mb-2">
